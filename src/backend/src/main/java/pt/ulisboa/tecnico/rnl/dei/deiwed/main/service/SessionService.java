...
public class SessionService {
	...
	private SessionDto addSession(Long id, SessionDto sessionDto) {
	...
	public SessionDto createSession(SessionDto sessionDto) {
		return addSession(null, sessionDto); // to ensure that the id is generated by the database
	}
	...
	public SessionDto updateSession(long id, SessionDto sessionDto) {
		...
		return addSession(id, sessionDto);
	}
