...
public class AttendeeService {
	...
	// NEW:
	private AttendeeDto addAttendee(Long id, AttendeeDto attendeeDto) {
	...
	public AttendeeDto createAttendee(AttendeeDto attendeeDto) {
		return addAttendee(null, attendeeDto); // to ensure that the id is generated by the database
	}
	...
	public AttendeeDto updateAttendee(long id, AttendeeDto attendeeDto) {
		...
		return addAttendee(id, attendeeDto);
	}
